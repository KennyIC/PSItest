...
if(day1.format('MM') > today.format('MM')){
	WebUI.click(findTestObject('1-3 Return/Payment date next month'))
...
WebUI.click(findTestObject('1-3 Return/Payment select'))

WebUI.selectOptionByValue(findTestObject('1-3 Return/Payment'), '0: 1', true)

WebUI.click(findTestObject('1-3 Return/Payment Date 1'))

//WebUI.click(findTestObject('1-3 Return/Payment date next month'))
WebUI.click(findTestObject('1-3 Return/Payment date 1 next month 10', [('xxx') : abc(5)]))

WebUI.click(findTestObject('1-3 Return/Payment Date 2'))

//WebUI.click(findTestObject('1-3 Return/Payment date 2 next month'))
WebUI.click(findTestObject('1-3 Return/Payment date 2 next month 15', [('xxx') : abc(10)]))

WebUI.click(findTestObject('1-3 Return/Payment Date 3'))

//WebUI.click(findTestObject('1-3 Return/Payment date 3 next month'))
WebUI.click(findTestObject('1-3 Return/Payment date 3 next month 20', [('xxx') : abc(15)]))
...
WebUI.setText(findTestObject('1-3 Return/Comment'), time())
